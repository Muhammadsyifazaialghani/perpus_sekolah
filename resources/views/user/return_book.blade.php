...
<div class="bg-gray-100 min-h-screen py-6 sm:py-10 px-4 animate-fadeIn">

    {{-- Form dibungkus dalam sebuah 'card' yang modern --}}
    <div class="max-w-sm sm:max-w-md md:max-w-2xl mx-auto bg-white rounded-2xl shadow-lg p-4 sm:p-6 md:p-8">

        <h1 class="text-xl sm:text-2xl md:text-3xl font-bold text-gray-800 text-center mb-4 sm:mb-6 md:mb-8">Formulir Pengembalian Buku</h1>
        ...
        <form action="{{ route('dashboard.return.process') }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <input type="date" id="return_date" name="return_date" value="{{ date('Y-m-d') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required readonly>
            </div>
